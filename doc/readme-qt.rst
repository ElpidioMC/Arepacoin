...
To use UPnP for port forwarding behind a NAT router (recommended, as more connections overall allow for a faster and more stable arepacoin experience), pass the following argument to qmake:
...
installed causes arepacoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
